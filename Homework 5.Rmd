...
ta1 <- Wong %>%
  ...
  summarise(MedianDays = median(days, na.rm=TRUE),
            quantileDays = quantile(days, 0.25, na.rm=TRUE),
            MedianDuration = median(duration, na.rm=TRUE),
            quantileduration = quantile(duration, 0.25, na.rm=TRUE),

knitr::kable((ta1
             col.names=c("Sex",
                         "Median Days","IQR Days",
                         "Median Duration","IQR Duration",
             caption="Summary Statistics of Wong Data")
```
...
knitr::kable(t2,
             col.names=c("Sex",
                         "Mean performance (i.e., mathematical) IQ","SD performance (i.e., mathematical) IQ",
                         "Mean verbal IQ","SD verbal IQ",
             caption="Summary Statistics of IQ)
```
